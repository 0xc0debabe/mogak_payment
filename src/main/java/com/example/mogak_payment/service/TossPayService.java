...
public class TossPayService {
    ...
    private static final String RET_URL = "https://api.mogak.kr:443/payment/callback";
    private static final String RET_CANCEL_URL = "https://api.mogak.kr:443/payment/cancel";
